...
description: 動態與測試審查員，負責執行單元測試、E2E 測試與實際 Runtime 運行驗證，確保程式碼可正確執行無報錯。用於 Phase 3 的動態驗證。
...
> 本檔為 `.antigravity/testing-reviewer.md` 的 Claude Code sub-agent 版本，行為定義與該檔同步維護，請勿各自修改後失去一致性。
